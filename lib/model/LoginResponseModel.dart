...
class Data {
    ...
    factory Data.fromJson(Map<String, dynamic> json) => Data(
        token: json["token"],
        userDetails: UserDetails.fromJson(json["user_details"]),
        sitterDetails: List<UserDetails>.from(json["sitter_details"].map((x) => x)),
        ownerDetails: List<dynamic>.from(json["owner_details"].map((x) => x)),
    );
    ...
    Map<String, dynamic> toJson() => {
        "token": token,
        "user_details": userDetails.toJson(),
        "sitter_details": List<dynamic>.from(sitterDetails.map((x) => x)),
        "owner_details": List<dynamic>.from(ownerDetails.map((x) => x)),
    };
}
...
class Data {
    ...
    Map<String, dynamic> toJson() => {
        "token": token,
        "user_details": userDetails.toJson(),
        "sitter_details": List<UserDetails>.from(sitterDetails.map((x) => x.toJson())),
        "owner_details": List<dynamic>.from(ownerDetails.map((x) => x)),
    };
}
